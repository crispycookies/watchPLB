...
void SystemClock_SleepMode_Config(void) {
	...
	//Turn off - Reference: https://community.st.com/s/question/0D50X00009XkWkgSAF/changing-clock-speed-during-runtime-64mhz-to-1mhz; seen 8.1.2019
	RCC->CR |= RCC_CR_HSION;
...
void SystemClock_UnSleepMode_Config(void){
	//Reference: https://community.st.com/s/question/0D50X00009XkWkgSAF/changing-clock-speed-during-runtime-64mhz-to-1mhz; seen 8.1.2019
	uint16_t timeout = 0xFFFF;
